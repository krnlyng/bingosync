...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='player',
            name='room',
            field=models.ForeignKey(to='bingosync.Room', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='goalevent',
            name='player',
            field=models.ForeignKey(to='bingosync.Player', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='goalevent',
            name='square',
            field=models.ForeignKey(to='bingosync.Square', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='game',
            name='room',
